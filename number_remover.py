...
def clean_transcript(input_file, output_file=None):
    """
    Clean a transcript by removing timestamps and auto-generated numbers.
...
def process_directory(input_dir, output_dir=None):
    ...
    for filename in os.listdir(input_dir):
        if filename.endswith('.docx'):
            ...
            result = clean_transcript(input_path, output_path)
            if result:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Clean transcript files by removing timestamps and auto-generated numbers")
